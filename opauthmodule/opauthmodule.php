...
class opauthmodule extends Module
{
	...
	public function install() {
		...
		if (!parent::install()
			...
			|| !Db::getInstance()->Execute('
				CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'opauth_google_customer`(
			...
			|| !Db::getInstance()->Execute('
				CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'opauth_twitter_customer`(
				`id` int(11) unsigned NOT NULL auto_increment,
			...
			|| !Db::getInstance()->Execute('
				CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'opauth_facebook_customer`(
				`id` int(11) unsigned NOT NULL auto_increment,
			...
			|| !Db::getInstance()->Execute('
				CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'opauth_linkedin_customer`(
				`id` int(11) unsigned NOT NULL auto_increment,
			...
			|| !Db::getInstance()->Execute('
				CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'opauth_paypal_customer`(
				`id` int(11) unsigned NOT NULL auto_increment,
	...
	public function uninstall() {
		...
		if (!parent::uninstall()
			...
			|| !Db::getInstance()->Execute('DROP TABLE `'._DB_PREFIX_.'opauth_google_customer` , `'._DB_PREFIX_.'opauth_twitter_customer`, `'._DB_PREFIX_.'opauth_facebook_customer`, `'._DB_PREFIX_.'opauth_linkedin_customer`, `'._DB_PREFIX_.'opauth_paypal_customer`')
			|| !Db::getInstance()->Execute('ALTER TABLE '._DB_PREFIX_.'customer DROP act_key'))
				return false;
		return true;
	}
